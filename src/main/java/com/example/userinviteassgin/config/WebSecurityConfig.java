...
import com.example.userinviteassgin.component.filter.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/group").hasRole("VALID_USER")
                .antMatchers("/api/sign-up").hasRole("NOT_VALID_USER")
